...
public class AStarSearchUpdating  implements UpdatingSearchAlgorithm {
	...
	public AStarSearchUpdating(Graph<String> graph) {
		this.graph = graph;
...
//		double diag = WEIGHTING*(dx+dy) + (WEIGHTING*1.41 -2*WEIGHTING)*Math.min(dx, dy);
