...
public class DjirkstaSearchUpdating implements UpdatingSearchAlgorithm{
	...
	public boolean searchForTarget(String source, String target) {
		...
		while(!pQ.isEmpty()) {
			...
			//boolean endOfTheRoad = true;	//not used??
			...
			prevVertex = currVertex;
			//TODO pushUpdatedDistances if flag set for visited vertices update mode -> too much..
		}
		pushEndMessage(false);
		return false;
	}
	...
	//Method for pushing of single distance result, used for individual updates
	@Override
